 ...
 * The {@link TDataSource} object also implements this interface so that it can be easily configured through
...
public interface PoolConfiguration {
     ...
     * Logging of abandoned Connections adds overhead for every Connection borrow because a stack trace has to be generated.
     * The default value is false.
     * @param logAbandoned set to true if stack traces should be recorded when {@link TDataSource#getConnection()} is called.
     */
    ...
    /**
     * Returns true if the call {@link TDataSource#getConnection(String, String) getConnection(username,password)} is
     ...
     * @return true if {@link TDataSource#getConnection(String, String) getConnection(username,password)} is honored, false if it is ignored.
     */
    public boolean isAlternateUsernameAllowed();

    /**
     * Set to true if the call {@link TDataSource#getConnection(String, String) getConnection(username,password)} is
     ...
     * @param alternateUsernameAllowed - set true if {@link TDataSource#getConnection(String, String) getConnection(username,password)} is honored,
